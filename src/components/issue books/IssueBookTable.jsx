...
import { issuedBooks } from '../../data/IssueBookData'
            ...
            {issuedBooks.map((data) => {
              return (
                ...
                >
                  ...
                  <td className={`p-1 text-center ${data.status === "Issued" ? "bg-green-100 text-green-700 px-1 py-2 rounded-full text-sm" : "bg-red-100 text-red-700 px-1 py-1 rounded-full text-sm"}`}>{data.status}</td>
