            ...
            {students.map((data) => {
              return (
                ...
                >
                  ...
                  <td className="p-4">{data.studentId}</td>
                  <td className="p-4">{data.department}</td>
                  <td className="p-4">{data.phone}</td>
                  <td className="p-4">{data.email}</td>
                  <td className={`p-1 text-center ${data.status === "Active" ? "bg-green-100 text-green-700 px-1 py-2 rounded-full text-sm" : "bg-red-100 text-red-700 px-1 py-1 rounded-full text-sm"}`}>{data.status}</td>
